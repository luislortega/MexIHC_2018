...
export class ColoquioPage {
  ...
  menu_coloquio = [
    ...
    {'title': 'User interfaces design through the use of human computer-interaction pattems', 'name':'Viridiana Silva Rodríguez, Sandra E. Nava Muñoz','url': 'http://convivenciaescolaryucatan.com.mx/php/pdfs/Colloquium/User Interfaces design through the use of Human Computer-Interaction Patterns.pdf '},
