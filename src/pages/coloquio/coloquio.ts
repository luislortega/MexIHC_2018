...
export class ColoquioPage {
  ...
  menu_coloquio = [
    ...
    {'title': 'iTVcARE: a home care system for the elderly through interactive television', 'name': 'Pedo C. Santana Mancilla, Luis E. Anido Rifón', 'url': 'http://convivenciaescolaryucatan.com.mx/php/pdfs/Colloquium/iTVCare a home care system for the elderly through interactive television.pdf ' },
    {'title': 'Identifying Human-Computer interaction patterns in support of the user interfaces design', 'name':'Viridiana Silva Rodríguez, Sandra E. Nava Muñoz','url': 'http://convivenciaescolaryucatan.com.mx/php/pdfs/Colloquium/User Interfaces design through the use of Human Computer-Interaction Patterns.pdf '},
